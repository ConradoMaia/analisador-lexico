...
public partial class MyLangBaseListener : IMyLangListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterDecl([NotNull] MyLangParser.DeclContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="MyLangParser.decl"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitDecl([NotNull] MyLangParser.DeclContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterExpr([NotNull] MyLangParser.ExprContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="MyLangParser.expr"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitExpr([NotNull] MyLangParser.ExprContext context) { }
	/// <summary>
